...
module.exports = {
    ...
    OWNER: process.env.OWNER_NAME === undefined ? 'Gigabyte' : process.env.OWNER_NAME,
    ...
    CAPTION: process.env.CAPTION_KEY === undefined ? 'Gigabyte' : process.env.BOT_NAME,
    ...
    GIGABYTE: process.env.GIGABYTE === undefined ? 'Gigabyte' : process.env.AMAZONE,
    ...
    KTB: process.env.TAG_HEADER === undefined ? 'Gigabyte' : process.env.TAG_HEADER,
    ...
    DEVELOPER: 'Gigabyte Dev.',
    AUTHOR: 'THEVINDU',
    PKGPS: process.env.PKGPS === undefined ?'=xnxcom' : process.env.PKGPS,
    GIT: 'https://github.com/ThevinduHansar/Gigabyte.git',
    HEROKU: {
