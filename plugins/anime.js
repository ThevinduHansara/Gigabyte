...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'anime', fromMe: true, desc: Lang.ANIM_DESC}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'anime', fromMe: false, desc: Lang.ANIM_DESC}, (async (message, match) => {
