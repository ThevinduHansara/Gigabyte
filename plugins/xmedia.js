...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'axmedia', fromMe: true, desc: Lang.XMEDİA_DESC}, (async (message, match) => {    
      ...
      Asena.addCommand({pattern: 'ocmds', fromMe: true, desc: Lang.ADMIN_DES}, (async (message, match) => {    
   ...
   Asena.addCommand({pattern: 'ocmds', fromMe: true, desc: 'set of commands for bot user or sudo'}, (async (message, match) => {    
